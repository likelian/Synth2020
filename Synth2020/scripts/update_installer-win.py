...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Synth2020 Demo Installer\n"
      else:
        line="OutputBaseFilename=Synth2020 Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Synth2020 Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Synth2020 installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Synth2020 Demo installer\n"
     else:
       line="SetupWindowTitle=Synth2020 installer\n"
