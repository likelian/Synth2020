...
//    pGraphics->AttachControl(new ISVGKnobControl(masterArea.GetCentredInside(100), knobSVG, kParamGain)); /* TASK_02 */
    ...
    pGraphics->AttachControl(new IVLabelControl(logoArea, "Synth2020", DEFAULT_STYLE.WithDrawFrame(false).WithValueText(IText(50., "Logo"))));
...
#if IPLUG_DSP
void Synth2020::ProcessBlock(sample** inputs, sample** outputs, int nFrames)
{
...
void Synth2020::ProcessMidiMsg(const IMidiMsg& msg)
{
  mSynth.AddMidiMsgToQueue(msg);
}

void Synth2020::OnReset()
{
  mSynth.SetSampleRateAndBlockSize(GetSampleRate(), GetBlockSize());
}

void Synth2020::OnParamChange(int paramIdx)
{
