/* Declares the Synth2020 Audio Worklet Node */

class Synth2020Controller extends WAMController
{
  constructor (actx, options) {
    ...
    super(actx, "Synth2020", options);
  }

  static importScripts (actx) {
    var origin = "https://likelian.github.io/Synth2020/";

    return new Promise( (resolve) => {
      actx.audioWorklet.addModule(origin + "scripts/Synth2020-wam.js").then(() => {
      actx.audioWorklet.addModule(origin + "scripts/wam-processor.js").then(() => {
      actx.audioWorklet.addModule(origin + "scripts/Synth2020-awp.js").then(() => {
        resolve();
      }) }) });
    })
  }
